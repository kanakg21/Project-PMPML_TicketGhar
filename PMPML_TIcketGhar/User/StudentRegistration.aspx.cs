...
namespace PMPML_TIcketGhar.User
{
    public partial class StudentRegistration : System.Web.UI.Page
    {
        ...
        protected void Register_Click(object sender, EventArgs e)
        {
            ...
            string query = "UPDATE StudentPass SET FullName = @FullName,Mobile = @Mobile,AadharNumber = @AadharNumber,Gender = @Gender,PRN = @PRN WHERE VerificationCode = @VerificationCode";
        ...
        private string PrnGeneration(string prn)
        {
            ...
            string messageBody = $"Welcome to PMPML TicketGhar Your PRN number is: {prn}";
